        ...
        <div>
            ...
            <div className="flex-container">
                <div className="inner-flex-container" style={{ backgroundColor: "#3e3e3e", maxWidth: "30%" }}>
                    ...
                    <div className="services-text"><p >No more wait times. No more hassle. Do your laundry at ease with Mercado Escolar.<br></br>
                ...
                <div className="inner-flex-container" style={{ backgroundColor: "#3e3e3e", maxWidth: "30%" }}>
                    ...
                    <div className="services-text"><p >Care and quality are the core values of Mercado Escolar dry cleaning and laundry
                        service.<br></br>
