...
function Service() {
    ...
    return (
        <div>
            ...
            <div className="flex-container">
                <div className="inner-flex-container" style={{ backgroundColor: "#3e3e3e", maxWidth: "30%" }}>
                    <div className="responsive"><img src={posts} style={{ height: "100%", width: "100%", objectFit: "contain" }} alt='posts'/></div>
      ...
      audience when they engage with your posts</p></div>
                ...
                <div className="inner-flex-container" style={{ backgroundColor: "#3e3e3e", maxWidth: "30%" }}>
                    <div className="responsive"><img src={adv} style={{ height: "100%", width: "100%", objectFit: "contain" }} alt='adv' /></div>
       ...
       interest, engagement, and sales </p></div>
                ...
                <div className="inner-flex-container" style={{ backgroundColor: "#3e3e3e", maxWidth: "30%" }}>
                    <div className="responsive"><img src={clubs}  style={{ height: "100%", width: "100%", objectFit: "contain" }} /></div>
      ...
      of leadership development and enhance collegiate experience</p></div>
            ...
            <div className="flex-container">
                <div className="inner-flex-container" style={{ backgroundColor: "#3e3e3e", maxWidth: "30%" }}>
                    <div className="responsive"><img src={razer} style={{ height: "100%", width: "100%", objectFit: "contain" }} alt='razer'/></div>
                ...
                <div className="inner-flex-container" style={{ backgroundColor: "#3e3e3e", maxWidth: "30%" }}>
                    <div className="responsive"><img src={radio} style={{ height: "100%", width: "100%", objectFit: "contain" }} alt='radio' /></div>
                ...
                <div className="inner-flex-container" style={{ backgroundColor: "#3e3e3e", maxWidth: "30%" }}>
                    <div className="responsive"><img src={cdc}  style={{ height: "100%", width: "100%", objectFit: "contain" }} /></div>
